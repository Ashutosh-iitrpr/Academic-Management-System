...
exports.StudentRecordsModule = StudentRecordsModule = __decorate([
    (0, common_1.Module)({
        controllers: [student_records_controller_1.StudentRecordsController],
        providers: [student_records_service_1.StudentRecordsService, prisma_service_1.PrismaService],
    })

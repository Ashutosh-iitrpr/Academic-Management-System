...
let FeedbackController = class FeedbackController {
    ...
    getFeedbackResultsByOffering(courseOfferingId, req) {
        return this.feedbackService.getFeedbackResultsByOffering(req.user.userId, courseOfferingId);
    }
...
__decorate([
    (0, common_1.Get)("instructor/course-offerings/:id/feedback-results"),
    (0, roles_decorator_1.Roles)("INSTRUCTOR"),
    __param(0, (0, common_1.Param)("id")),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], FeedbackController.prototype, "getFeedbackResultsByOffering", null);
__decorate([
